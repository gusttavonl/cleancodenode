...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if no passowrdConfirmation is provided', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 400 if passowrdConfirmation fails', () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
  ...
  test('Should return 400 if is invalid email is provided', () => {
